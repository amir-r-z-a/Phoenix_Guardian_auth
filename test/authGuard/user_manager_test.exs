defmodule AuthGuard.UserManagerTest do
  use AuthGuard.DataCase

  alias AuthGuard.UserManager

  describe "users" do
    alias AuthGuard.UserManager.User

    import AuthGuard.UserManagerFixtures
